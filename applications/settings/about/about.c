...
static DialogMessageButton about_screen_product(DialogsApp* dialogs, DialogMessage* message) {
    ...
    // Obfuscated string: "Firmware 2.1 for Oled flipper.\nLink: github.com/artema0g/\noled_flipper"
    const uint8_t encrypted_text[] = {0x1c, 0x33, 0x28, 0x37, 0x2d, 0x3b, 0x28, 0x3f, 0x7a, 0x68,
                                      0x74, 0x6b, 0x7a, 0x3c, 0x35, 0x28, 0x7a, 0x15, 0x36, 0x3f,
                                      0x3e, 0x7a, 0x3c, 0x36, 0x33, 0x2a, 0x2a, 0x3f, 0x28, 0x74,
                                      0x50, 0x16, 0x33, 0x34, 0x31, 0x60, 0x7a, 0x3d, 0x33, 0x2e,
                                      0x32, 0x2f, 0x38, 0x74, 0x39, 0x35, 0x37, 0x75, 0x3b, 0x28,
                                      0x2e, 0x3f, 0x37, 0x3b, 0x6a, 0x3d, 0x75, 0x50, 0x35, 0x36,
                                      0x3f, 0x3e, 0x05, 0x3c, 0x36, 0x33, 0x2a, 0x2a, 0x3f, 0x28};
    char decrypted_text[71];
    for(size_t i = 0; i < 70; i++) {
        decrypted_text[i] = (char)(encrypted_text[i] ^ 0x5A);
    }
    decrypted_text[70] = '\0';

    FuriString* screen_text = furi_string_alloc_set_str(decrypted_text);
