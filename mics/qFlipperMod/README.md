...
5. Once complete, put the board back into DFU mode and select **"Install from file"** to flash the custom **`.tgz`** firmware package from [Releases](https://github.com/AJ60/Flipper_OLED_PCF8574_PN532/releases).
