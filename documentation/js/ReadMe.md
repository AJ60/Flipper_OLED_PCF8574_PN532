...
> You should instead look at the TypeScript definitions (`.d.ts`) in [`applications/system/js_app/packages/fz-sdk`](https://github.com/AJ60/Flipper_OLED_PCF8574_PN532/tree/main/applications/system/js_app/packages/fz-sdk) and examples in [`applications/system/js_app/examples/apps/Scripts`](https://github.com/AJ60/Flipper_OLED_PCF8574_PN532/tree/main/applications/system/js_app/examples/apps/Scripts), these will always reflect what is actually available in the JS engine. \
