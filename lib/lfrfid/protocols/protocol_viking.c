...
// DIY: BC557 slow coil fall stretches RF/32 short ~128us to ~136-140us.
// Stock mid~188 left gap before long; keep short below ~170, long from there.
#define VIKING_READ_SHORT_TIME_LOW  (60)
#define VIKING_READ_SHORT_TIME_HIGH (170)
#define VIKING_READ_LONG_TIME_LOW   (170)
#define VIKING_READ_LONG_TIME_HIGH  (450)
